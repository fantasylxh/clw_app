...
class ArticleController extends Controller
{
    ...
    public function index(Request $requests)
    {
        ...
        $articles = Article::orderBy('id','desc')->select(\DB::raw("id,article_author,article_date_v,article_title,CONCAT('".env('ATTACHMENT_URL')."',resp_img) as resp_img "))->where(['article_category'=>1])->paginate(2)->toArray();
