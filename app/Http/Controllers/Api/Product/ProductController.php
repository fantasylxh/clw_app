...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        /* 最实惠 */
        $bool= Product::limit(2)->orderBy('id','desc')->select(\DB::raw("id as product_id,title as product_name,CONCAT('".env('ATTACHMENT_URL')."',thumb) as product_img,marketprice as product_price,unit,total"))->where(['isdiscount'=>1])->get()->toArray();
        /* 主题旅游 */
