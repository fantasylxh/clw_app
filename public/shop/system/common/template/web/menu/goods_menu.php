...
<h3>
    <i class="main_i_icon1  fa fa-book">&nbsp;</i>社区管理
</h3>
<ul>
    <li <?php  if($_GPC['do'] == 'shop' ) { ?> <?php  if($_GPC['act'] == 'categorys') { ?> class="current" <?php  } ?> <?php  } ?>>
        <a href="<?php  echo create_url('site',array('act' => 'categorys','do' => 'shop','m' => 'eshop'))?>">分类管理 </a>
    </li>
