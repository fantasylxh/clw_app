		...
		<div class="col-sm-7" style='padding-right:1px;padding-left:1px;position:relative'>
               	...
               	<input type="text" name="article_title" class="form-control" value="<?php  echo $article['article_title'];?>" data-rule-required='true' bind-in="art_title" placeholder="标题或姓名"/>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">区域分类</label>
                            <div class="col-sm-8 col-xs-12">


                                <?php  echo tpl_form_field_category_2level('category', $parent, $children, $article['pcate'], $article['ccate'])?>
