...
<?php include page("system_header");?>
 ...
 <div class="panel ">
       ...
       <div class="panel-body">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        城里网微信App&nbsp;V<?php echo defined('SAPP_VERSION')?SAPP_VERSION:"4.0.0";?>&nbsp;&nbsp;<?php echo $localversion;?>
                    </div>
                </div>
                    ...
                    <div class="col-sm-9 col-xs-12">
                          	 城里网微信App&nbsp;V<?php echo defined('SAPP_VERSION')?SAPP_VERSION:"4.0.0";?>&nbsp;&nbsp;<?php echo CORE_VERSION;?>
                    </div>
                </div>
